...
Rails.application.routes.draw do
    ...
    # get '/state/:state_symbol/county/:std_fips_code' => 'search#county', :as => :county
    ...
    post '/my_news_item/save' => 'my_news_items#save', :as => :save_my_news_item
    ...
    resources :representatives do
        ...
        get '/representatives/my_news_item/new' => 'my_news_items#new'
        ...
        match '/representatives/:representative_id/my_news_item/:id', to:  'my_news_items#destroy',
                                                                      via: [:delete]
        # get '/my_news_item/search/:representative_id/:id', to:  'my_news_items#search', :as => :search_my_news_item
        # post '/my_news_item/search/:representative_id/:id', to:  'my_news_items#save', :as => :save_my_news_item                                                   
    end
    get '/search/(:address)' => 'search#search', :as => 'search_representatives'
    # get '/my_news_item/search/:representative_id/:id', to:  'my_news_items#search', :as => :search_my_news_item
    # post '/my_news_item/search/:representative_id/:id', to:  'my_news_items#save', :as => :save_my_news_item
    
    # get '/my_news_item/search/:representative_id/:issue', to:  'my_news_items#top_5', :as => :top_5_my_news_item
    # post '/search/news_item/:id' => 'my_news_items#search', :as => :search_my_news_items
    # get '/search/(:address)' => 'representatives#search', :as => 'search_representatives'
end
